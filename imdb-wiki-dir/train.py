...
#
# new added train number
#
parser.add_argument('--train_number', type=int, default=1000, help='number of samples in first age to train')
#
...
# add the args.train_number in the logger
args.store_name = f"{args.dataset}_{args.model}{args.store_name}_{args.optimizer}_{args.loss}_{args.lr}_{args.batch_size}_{args.train_number}"
